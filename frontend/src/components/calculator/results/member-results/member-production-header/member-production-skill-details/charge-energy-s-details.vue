    ...
    <v-col cols="auto" class="flex-center flex-nowrap mx-4">
      ...
      >
        <v-img
          ...
          height="40px"
          width="40px"
          :alt="`Charge Energy S level ${memberWithProduction.member.skillLevel}`"
...
import { getIsland } from 'sleepapi-common'
import { useTeamStore } from '@/stores/team/team-store'
import { useUserStore } from '@/stores/user-store'
import type { MemberProductionExt } from '@/types/member/instanced'
import { ChargeEnergyS, MathUtils, compactNumber } from 'sleepapi-common'
    ...
    totalSkillValue() {
      return compactNumber(
        StrengthService.skillValue({
          skillActivation: ChargeEnergyS.activations.energy,
