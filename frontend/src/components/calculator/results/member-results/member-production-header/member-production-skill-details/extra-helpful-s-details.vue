    ...
    <v-col cols="auto" class="flex-center flex-nowrap">
      ...
      >
        <v-img
          ...
          height="40px"
          width="40px"
          :alt="`Extra Helpful S level ${memberWithProduction.member.skillLevel}`"
...
import { ExtraHelpfulS, MathUtils, compactNumber, getIsland } from 'sleepapi-common'
    ...
    totalSkillValue() {
      return compactNumber(
        StrengthService.skillValue({
          skillActivation: ExtraHelpfulS.activations.helps,
