    ...
    <v-col cols="auto" class="flex-center flex-nowrap mx-4">
      ...
      >
        <v-img
          ...
          height="40px"
          width="40px"
          :alt="`Charge Strength S level ${memberWithProduction.member.skillLevel}`"
...
import { ChargeStrengthSRange, MathUtils, compactNumber } from 'sleepapi-common'
    ...
    totalSkillValue() {
      return compactNumber(
        StrengthService.skillValue({
          skillActivation: ChargeStrengthSRange.activations.strength,
