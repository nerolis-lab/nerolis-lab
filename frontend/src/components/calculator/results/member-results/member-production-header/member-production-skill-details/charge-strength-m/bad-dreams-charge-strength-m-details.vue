    ...
    <v-col cols="auto" class="flex-center flex-nowrap mx-4">
      ...
      >
        <v-img
          ...
          height="40px"
          width="40px"
          :alt="`Bad Dreams (Charge Strength M) level ${memberWithProduction.production.skillLevel}`"
          title="Bad Dreams (Charge Strength M)"
        ></v-img>
      </v-badge>
      <div class="ml-2">
...
export default defineComponent({
  ...
  computed: {
    ...
    totalEnergyDegraded() {
      return compactNumber(this.memberWithProduction.production.skillValue?.energy?.amountToTeam ?? 0)
    },
    timeWindowFactor() {
