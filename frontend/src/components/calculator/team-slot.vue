...
export default defineComponent({
  ...
  methods: {
    openFilledSlotActions(pokemonInstance: PokemonInstanceExt) {
      this.dialogStore.openSlotActions(pokemonInstance, this.fullTeam, {
    ...
    // TODO: might need to move this to the pokemon search component so that it always returns an instance
    createPokemonFromSelection(pokemon: Pokemon) {
      const gender = getRandomGender(pokemon)
