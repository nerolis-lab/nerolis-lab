...
logger.debug(JSON.stringify(props.previousIsland))
...
watch(props.previousIsland, (newIsland) => {
  island.value = newIsland
})

const areaBonus = (island: IslandInstance): number => userStore.areaBonus[island.shortName]
