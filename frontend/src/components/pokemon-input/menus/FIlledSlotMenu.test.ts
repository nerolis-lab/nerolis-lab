...
describe('FilledSlotMenu', () => {
  ...
  it('renders correctly when dialog is closed', async () => {
    dialogStore.slotActionsDialog = false
  ...
  it('renders correctly when dialog is open with pokemon', async () => {
    ...
    dialogStore.openSlotActions(mockPokemon, false, {})
    await wrapper.vm.$nextTick()
  ...
  it('toggles save and calls server', async () => {
    ...
    dialogStore.openSlotActions(mockPokemon, false, { onToggleSaved })
    await wrapper.vm.$nextTick()
  ...
  it('opens PokemonInput on edit click', async () => {
    ...
    dialogStore.openSlotActions(mockPokemon, false, { onUpdate })
    await wrapper.vm.$nextTick()
  ...
  it('duplicates member', async () => {
    ...
    dialogStore.openSlotActions(mockPokemon, false, { onDuplicate })
    await wrapper.vm.$nextTick()
  ...
  it('removes member and closes dialog', async () => {
    ...
    dialogStore.openSlotActions(mockPokemon, false, { onRemove })
    await wrapper.vm.$nextTick()
  ...
  it('disables duplicate button when team is full', async () => {
    pokemonStore.upsertLocalPokemon(mockPokemon)
    dialogStore.openSlotActions(mockPokemon, true, {})
    await wrapper.vm.$nextTick()
