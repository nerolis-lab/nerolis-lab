...
This is the [list of all the skills in the game](https://www.serebii.net/pokemonsleep/skills.shtml). Not all of them are meta-relevant so I will group them based on role and focus on just the ones that are. Note that some skills are variants of each other.
...
DSM Mons are covered extensively in [Pokémon Sleep Discord server](https://discord.gg/pokemonsleep)'s #the-swa-lot pins. I personally believe this is the 4th or 5th most important skill mon in the game as they really help you push multiple mons to lvl 60+.

#### Legendary Skills

Legendary Mons _can_ provide solid value. However, these Mons are extremely niche due to their high Biscuit catch cost, _meh_ default stats upon initial encounter, highly specific team building, and low encounter rate outside of dedicated events. **In no way are Legendaries mandatory for game progress.**
