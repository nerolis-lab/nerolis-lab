...
1. Strength skillmons compete with favored bfs berry mons so use that as a reference of comparison. Use one of the many calculators available to you in the [FAQ] OMITTED CONTENT -> SCREENSHOT USAGE
...
2. Use this [Rating Guide](./rating-intro.md)

## Important Notes About Berry Strength and Pokemon Levels

1. Berry strength increases with **each** level. As a result, trigger builds **slowly** lose ground to a previously equivalent BFS build at higher levels.
...
- In regards to Exp natures: They are about equivalent to Help natures due to the exp adjustment on them affecting berry strength. See for details: OMITTED PAGE -> SCREENSHOT USAGE
...
- Funnily enough, both Calm (MS+, SOH-) AND Naughty (SOH+, MS-) are both net positives due to SOH- getting buffed recently. Despite this, they are closer to neutral natures than good natures
