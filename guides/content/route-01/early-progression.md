...
- **Charge Strength M (CSM)**: Provides an early boost to Snorlax strength without relying on Pokemon levels, at the cost of MSS. This can raise your standards when hunting for a permanent BFS Berry mon per island, as you won't need to settle as quickly. Keep in mind that high-level Berry mons will eventually surpass even well-invested CSM mons.
  - Mareep
  - Noibat
  - Eevee (Espeon)
- **Ingredient Magnet (Ing Mag)**: Buys time when hunting for long-term Ingredient mons. Ingredient mons are notoriously weak before level 30, so a good Ing Mag mon can enable more consistent cooking in the early game, at the cost of MSS. Even after your Ingredient mons have developed, an Ing Mag mon can still be useful for refilling your ingredient bag.
  - Heracross
  - Eevee (Vaporeon)
...
**Do NOT rely on PRs or tier lists**
...
The [Pokémon evaluation](../pokemon-evaluation/) guides are a good starting point for judging subskills, natures, and matching the right ones to your Pokémon's specialty (ingredient finders are very important for ingredient specialists but less so on skill specialists).
